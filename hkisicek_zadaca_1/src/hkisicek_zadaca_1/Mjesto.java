...
public class Mjesto {
    ...
    public void setSenzoriMjesta(List<Senzor> senzoriMjesta) {
        this.senzoriMjesta = senzoriMjesta;
    }
    ...
    public void setAktuatoriMjesta(List<Aktuator> aktuatoriMjesta) {
        this.aktuatoriMjesta = aktuatoriMjesta;
    }
