...
public final class Greske {
    ...
    public static final String MJESTA_GRESKA_08 = "Navedeno mjesto ne postoji.";
    ...
    public static final String SENZOR_GRESKA_07 = "Nema više tog modela uređaja. Ide nabava.";
    ...
    public static final String AKTUATOR_GRESKA_07 = "Nema više tog modela uređaja. Ide nabava.";
    ...
    public static final String RASPORED_GRESKA_06 = "Pogresan raspored mjesta. Mjesto ne postoji.";
    ...
    public static String vratiGreskuSenzor(int id_greske) {
        if (id_greske == 1) {
            ...
            return SENZOR_GRESKA_00 + " " + SENZOR_GRESKA_07;
        } else {
            return "";
        }
    }
    ...
    public static String vratiGreskuAktuator(int id_greske) {
        if (id_greske == 1) {
            ...
            return AKTUATOR_GRESKA_00 + " " + AKTUATOR_GRESKA_07;
        } else {
            return "";
        }
    }
    ...
    public static String vratiGreskuRaspored(int id_greske) {
        if (id_greske == 1) {
            ...
            return RASPORED_GRESKA_00 + " " + RASPORED_GRESKA_06;
        } else {
            return "";
        }
    }
