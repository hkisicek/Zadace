...
public class GlavniView {
    ...
    public void ispisiIzbornik() {
        ...
        System.out.println("SM x - ispis strukture mjesta x");
        System.out.println("TS x  - ispis podataka o kolekciji modela senzora x");
        System.out.println("TA x  - ispis podataka o kolekciji modela aktuatora x");
        ...
        System.out.println("CP n - broj ciklusa dretve uređaja (1-99)");
